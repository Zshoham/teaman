                  ...
                  <div className="relative">
                    <Input
                      ...
                      onBlur={(event) => {
                        ...
                        const movedToSubmenu =
                          nextTarget instanceof Element &&
                          nextTarget.closest(
                            '[data-slot="dropdown-menu-sub-content"]'
                          )
                        if (activeMenu === "root" && !movedToSubmenu) {
                          rootInputRef.current?.focus()
                        }
                      }}
                      ...
                      return filteredFields.map((field, index) => {
                        ...
                        if (hasSubMenu) {
                          ...
                          const fieldFilters = filters.filter(
                            (filter) => filter.field === fieldKey
                          )
                          // Reopening a field should edit its existing compact
                          // filter instead of starting an unchecked duplicate.
                          const sessionFilter =
                            (sessionFilterId
                              ? filters.find(
